var languageContent = {
    greek: {
      languageBtn: "EL",
      mainTitle: "",
      pageTitle: "Ευρωπαϊκή Κάρτα Ασφάλισης Ασθενείας",
      infoTitle: "Πληροφορίες για την έκδοση της Ευρωπαϊκής Κάρτας Ασφάλισης Ασθενείας",
      subTitle1: "Αυτό το ερωτηματολόγιο μπορεί να σας βοηθήσει να βρείτε αν δικαιούστε να λάβετε την Ευρωπαϊκή Κάρτα Ασφάλισης Ασθενείας.",
    ...
    english: {
      languageBtn: "EN",
      mainTitle: "European Health Insurance Card",
      pageTitle: "European Health Insurance Card",
      infoTitle: "Information on the European Health Insurance Card",
      subTitle1: "This questionnaire can help you determine if you are eligible to receive the European Health Insurance Card.",
